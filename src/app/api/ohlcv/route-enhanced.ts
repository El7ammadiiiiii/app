...
const INTERVAL_MAPPINGS: Record<string, Record<string, string>> = {
  binance: { "1m": "1m", "5m": "5m", "15m": "15m", "30m": "30m", "1h": "1h", "4h": "4h", "1d": "1d", "3d": "3d", "1w": "1w" },
  bybit: { "1m": "1", "5m": "5", "15m": "15", "30m": "30", "1h": "60", "4h": "240", "1d": "D", "3d": "D", "1w": "W" },
  mexc: { "1m": "1m", "5m": "5m", "15m": "15m", "30m": "30m", "1h": "60m", "4h": "4h", "1d": "1d", "3d": "1d", "1w": "1W" },
  coinbase: { "1m": "60", "5m": "300", "15m": "900", "30m": "1800", "1h": "3600", "4h": "14400", "1d": "86400", "3d": "86400", "1w": "604800" },
  kucoin: { "1m": "1min", "5m": "5min", "15m": "15min", "30m": "30min", "1h": "1hour", "4h": "4hour", "1d": "1day", "3d": "1day", "1w": "1week" },
  okx: { "1m": "1m", "5m": "5m", "15m": "15m", "30m": "30m", "1h": "1H", "4h": "4H", "1d": "1D", "3d": "1D", "1w": "1W" },
  bitget: { "1m": "1min", "5m": "5min", "15m": "15min", "30m": "30min", "1h": "1h", "4h": "4h", "1d": "1day", "3d": "1day", "1w": "1week" },
  bingx: { "1m": "1m", "5m": "5m", "15m": "15m", "30m": "30m", "1h": "1h", "4h": "4h", "1d": "1d", "3d": "1d", "1w": "1w" },
  phemex: { "1m": "1", "5m": "5", "15m": "15", "30m": "30", "1h": "60", "4h": "240", "1d": "1440", "3d": "1440", "1w": "10080" },
  htx: { "1m": "1min", "5m": "5min", "15m": "15min", "30m": "30min", "1h": "60min", "4h": "4hour", "1d": "1day", "3d": "1day", "1w": "1week" },
  gate: { "1m": "1m", "5m": "5m", "15m": "15m", "30m": "30m", "1h": "1h", "4h": "4h", "1d": "1d", "3d": "1d", "1w": "1w" },
  cryptocom: { "1m": "1m", "5m": "5m", "15m": "15m", "30m": "30m", "1h": "1h", "4h": "4h", "1d": "1D", "3d": "1D", "1w": "1W" },
  kraken: { "1m": "1", "5m": "5", "15m": "15", "30m": "30", "1h": "60", "4h": "240", "1d": "1440", "3d": "1440", "1w": "10080" }
};
...
const VALID_INTERVALS = ["1m", "5m", "15m", "30m", "1h", "4h", "1d", "3d", "1w"];
...
async function fetchFromExchange(exchange: string, symbol: string, interval: string, limit: number): Promise<OHLCV[] | null> {
  ...
  try {
    switch (exchange) {
      case "binance":
        return await fetchBinance(symbol, mappedInterval, limit);
      case "bybit":
    ...
    if (exchange !== "binance") {
      ...
      return await fetchBinance(symbol, INTERVAL_MAPPINGS.binance[interval] || interval, limit);
    }
    return null;
  }
}
...
export async function POST(request: NextRequest) {
  try {
    ...
    const { symbols, interval = "1h", limit = 100, exchange = "binance" } = body;
