...
/**
 * Descending Triangle (Expanding) Detection
 */
function detect(pivots, ohlc, scanSettings) {
    ...
    // Descending Triangle (Expanding): Flat resistance (highs) and falling support (lows)
    // → Lines diverge: bottom falls while top stays flat
    ...
    // Expanding: Lines must diverge (low slope < high slope, both sides of zero)
