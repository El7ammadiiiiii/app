...
/**
 * Ascending Triangle (Expanding) Detection
 */
function detect(pivots, ohlc, scanSettings) {
    ...
    // Ascending Triangle (Expanding): Rising resistance (highs) and flat support (lows)
    // → Lines diverge: top rises while bottom stays flat
    ...
    // Expanding: Lines must diverge (high slope > low slope)
