...
/**
 * Falling Wedge (Expanding) Detection
 */
function detect(pivots, ohlc, scanSettings) {
    ...
    // Expanding: Lines must diverge (low slope < high slope because both are negative)
    ...
    // ── Breakout detection (bullish — close above resistance) ──
