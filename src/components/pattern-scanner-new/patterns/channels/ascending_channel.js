...
function detect(pivots, ohlc, scanSettings) {
    ...
    // ── Breakout Detection ──────────────────────────────────────────────────
    // Ascending Channel = bullish formation → breakout is BEARISH (price closes BELOW support)
