...
export const connectorConfig = {
  connector: 'example',
  serviceId: 'ccways-5a160-service',
  location: 'us-east4'
};
...
export function getProjectsByUser(dcOrOptions, options) {
  const { dc: dcInstance, options: inputOpts} = validateAdminArgs(connectorConfig, dcOrOptions, options, undefined);
  dcInstance.useGen(true);
  return dcInstance.executeQuery('GetProjectsByUser', undefined, inputOpts);
}
